...
The Level 5 proof dataset is generated by `npm run prisma:seed`. It is intentionally labeled synthetic QA data for reviewer validation, not real external user acquisition.

- `50` synthetic QA users
